...
export const EditorData = () => (
  <div>
    <h3>
    Hey it's Matt! Go ahead and learn more about me below or edit away as you'd like!
    </h3>
    <h5>
    As a software developer and CPA, my passion lies with operating in a team environment, coaching and learning from fellow team members, and delivering timely, impactful solutions. 

    Over the course of my career, I’ve collaborated with some outstanding individuals across the financial and commercial (i.e. technology, real estate, etc.) service lines. My experiences thus far relate to operations in the Northeastern (Greater New York City Area) and Southeastern (Greater Florida Area) regions. 

    My professional experiences continue to refine my overall personal development. My time at EY allowed me to tackle new challenges daily. As a self-starter, I resonated with the ability to solve fresh team- or client- focused challenges. Thus, I embraced the overall team environment. The ability to lead high-performing teams, mentor fellow team members, and learn from outstanding professionals provided me a strong sense of purpose everyday. A team/family focused ("we") approach became innate to all of our teams. Additionally, I enjoy my involvement within the community, such as my experiences with Marine Education Initiative (fka: Fishing for Families in Need), to pioneer positive actions and ideas. Furthermore, graduating as a Software Developer from Flatirons School (Full Stack | JavaScript | React | Ruby | Rails | SQL | HTML | CSS) fostered a passion for a new, exciting skill and a deeper understanding within the tech industry. 

    Feel free to reach out should you want to make a connection, grab a coffee, and figure out how we can solve the next big problem. Always open to network and connect.
    </h5>
    <a>
    https://www.linkedin.com/in/matt-mckay-cpa/
    </a>
  </div>
);
